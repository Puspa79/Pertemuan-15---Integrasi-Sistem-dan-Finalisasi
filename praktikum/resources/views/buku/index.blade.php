                    ...
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/70">
                            ...
                            <th class="p-4 font-semibold text-gray-500 text-sm uppercase tracking-wider w-60">Sampul /
                                Kode</th>
                            <th class="p-4 font-semibold text-gray-500 text-sm uppercase tracking-wider">Informasi Buku
                            </th>
                            <th
                        ...
                        @forelse ($bukus ?? [] as $buku)
                            <tr class="hover:bg-gray-50/40 transition duration-150">
                                ...
                                <td class="p-4 text-right">
                                    ...
                                    @if (($buku->stok ?? 20) > 0)
                                        <span
                                            class="inline-block text-sm font-semibold px-2.5 py-0.5 bg-green-50 text-green-600 border border-green-100 rounded-full">
                                            Tersedia ({{ $buku->stok ?? 20 }})
                                        </span>
                                    @else
                                        <span
                                ...
                                <td class="p-4">
                                    <div class="flex items-center justify-center gap-1.5">
                                        ...
                                        <a href="{{ route('buku.edit', $buku->id ?? 1) }}"
