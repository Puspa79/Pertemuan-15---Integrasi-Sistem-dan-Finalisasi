        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-6">
                <div class="card shadow-sm overflow-hidden h-100">
                    <div
                        class="card-header bg-light py-3 px-4 d-flex justify-content-between align-items-center border-bottom-0">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex flex-column">
                            @forelse($anggotaTerbaru as $anggota)
                                <div class="d-flex align-items-center justify-content-between py-3 px-4 border-bottom card-hover bg-white"
                                    ...
                                    <span class="badge bg-light text-secondary border rounded px-2.5 py-1"
